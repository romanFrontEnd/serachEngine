...
public class LittleSearchEngine {
    ...
    private String baseDir = System.getProperty("user.dir") + "/src/main/java/docs/";
     ...
     * each of which is associated with an array list of example.Occurrence objects, arranged
    ...
    public void makeIndex(String docsFile, String noiseWordsFile)
        ...
        Scanner sc = new Scanner( new File(baseDir +  noiseWordsFile));
        while (sc.hasNext()) {
            String word = sc.next();
        ...
        // index all keywords
        sc = new Scanner(new File(baseDir +   docsFile));
        while (sc.hasNext()) {
            String docFile = sc.next();
            HashMap<String, Occurrence> kws = loadKeyWords( baseDir +  docFile);
            mergeKeyWords(kws);
        }
    }
     ...
     * @return Hash table of keywords in the given document, each associated with an example.Occurrence object
     * @throws FileNotFoundException If the document file is not found on disk
     */
    public HashMap<String, Occurrence> loadKeyWords( String docFile)
            throws FileNotFoundException
    {
        if (baseDir +  docFile == null)
     ...
     * hash table. For each keyword, its example.Occurrence in the current document
     * must be inserted in the correct place (according to descending order of
     * frequency) in the same keyword's example.Occurrence list in the master hash table.
